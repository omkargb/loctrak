...
let lset = [
   ...
   [17.0515814, 73.5684563, "Ambav khind आंबव खिंड "],
   ...
   [16.9980558, 73.3578452, "Ratnagiri Railway station रत्नागिरी रेल्वे स्टेशन रोड "],
...
for (let i = 0; i < lset.length ; i++) 		//no of locations
{
   ...
   {
		if((Math.abs(clat-(lset[i][j]))<=0.00400) && (Math.abs(clong-(lset[i][j+1]))<=0.00400))
		{
